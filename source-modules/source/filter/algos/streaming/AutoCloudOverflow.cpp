#include <algos/streaming/AutoCloudOverflow.h>
#include "data/FileVideoInput.h"
#include <regex>

int filter::algos::AutoCloudOverflow::getLastKnownIDFromDirectory()
{
...
HipeStatus filter::algos::AutoCloudOverflow::savePaternPicture(const cv::Mat& picture)
{
...
HipeStatus filter::algos::AutoCloudOverflow::process()
{
