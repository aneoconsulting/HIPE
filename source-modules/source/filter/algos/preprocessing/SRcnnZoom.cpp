...
#include <algos/preprocessing/SRcnnZoom.h>
...
***/
HipeStatus filter::algos::SRcnnZoom::process()
{
	/* Read the original image */
	data::ImageArrayData imgArray = _connexData.pop();
	Mat pImgOrigin = imgArray.Array()[0];
...
//#endif
	...
	data::ImageData result(pImgBGROut);;
