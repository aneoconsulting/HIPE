...
macro(hipe_find_dependencies list_deps target_name BUILD_CONFIG)
  if (WIN32)
	...
	if (WIN32)
		...
		set(PATH_SHAREDLIB "${HIPE_EXTERNAL_DIR}/boost/lib;${HIPE_EXTERNAL_DIR}/opencv/lib;${cm_dir};${CMAKE_PREFIX_PATH};${HIPE_EXTERNAL_DIR}/caffe/lib;${CMAKE_INSTALL_PREFIX}/bin/${BUILD_CONFIG};${CMAKE_INSTALL_PREFIX}/lib/${BUILD_CONFIG}")
