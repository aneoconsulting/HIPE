...
if (WIN32)
  ...
  set(LiveMedia_DIR "${HIPE_EXTERNAL}/${HIPE_PLATFORM}/live555/install"  CACHE PATH "LiveMedia_DIR" FORCE)
  ...
  set(Boost_DIR "${HIPE_EXTERNAL}/${HIPE_PLATFORM}"   CACHE PATH "Boost_DIR")
  ...
  set(LiveMedia_DIR "${HIPE_EXTERNAL}/${HIPE_PLATFORM}/"  CACHE PATH "LiveMedia_DIR")

  set(FFMPEG_DIR "${HIPE_EXTERNAL}/${HIPE_PLATFORM}/"  CACHE PATH "FFMPEG_LIBRARYDIR")
  set(PYTHON27_DIR "${Hipe_external}/${HIPE_PLATFORM}/python27/"  CACHE PATH "PYTHON_LIBRARYDIR")

  set(DLIB_DIR "${HIPE_EXTERNAL}/${HIPE_PLATFORM}/"  CACHE PATH "DLIB_LIBRARYDIR")
  set(USE_DLIB On  CACHE bool "Activate Dlib library" FORCE)
endif()
