...
foreach(COMPONENT  ${COMPONENTS})
  if(NOT TARGET dlib::${COMPONENT})
    ...
    if(WIN32)
      ...
      set(COMMON_DLIB_LIB_DEPS "ws2_32;winmm;comctl32;gdi32;imm32;${HIPE_EXTERNAL}/${HIPE_PLATFORM}/intel64_win/mkl_intel_lp64.lib;${HIPE_EXTERNAL}/${HIPE_PLATFORM}/intel64_win/mkl_core.lib;${HIPE_EXTERNAL}/${HIPE_PLATFORM}/intel64_win/mkl_intel_thread.lib;${HIPE_EXTERNAL}/${HIPE_PLATFORM}/intel64_win/libiomp5md.lib;${HIPE_EXTERNAL}/${HIPE_PLATFORM}/intel64_win/mkl_intel_lp64.lib;${HIPE_EXTERNAL}/${HIPE_PLATFORM}/intel64_win/mkl_core.lib;${HIPE_EXTERNAL}/${HIPE_PLATFORM}/intel64_win/mkl_intel_thread.lib;${HIPE_EXTERNAL}/${HIPE_PLATFORM}/intel64_win/libiomp5md.lib;C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v8.0/lib/x64/cublas.lib;C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v8.0/lib/x64/cublas_device.lib;C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v8.0/lib/x64/cudnn.lib;C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v8.0/lib/x64/curand.lib;C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v8.0/lib/x64/cusolver.lib")
