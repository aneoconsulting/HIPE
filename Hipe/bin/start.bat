...
HIPE_EXTERNAL=C:\workspace\ANEO\Project\HipeExternal\win64
set PATH=C:\workspace\ANEO\Project\HipeExternal\win64\hipeModules\bin\Release;%PATH%
hipe_server.exe -m C:\workspace\ANEO\Project\HipeExternal\win64\hipeModules\bin\Release\filter.dll
