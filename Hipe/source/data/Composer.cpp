...
data::Data data::Composer::loadListIoData(const boost::property_tree::ptree& dataNode)
{
	std::vector<Data> res;
...
data::Data data::Composer::loadPatternData(const boost::property_tree::ptree& dataNode)
{
	std::vector<Data> res;
 ...
 */
data::Data data::Composer::getDataFromComposer(const boost::property_tree::ptree& dataNode)
{
	data::Composer::checkJsonFieldExist(dataNode, "type");
