...
H264LiveServerMediaSession* H264LiveServerMediaSession::createNew(UsageEnvironment& env, bool reuseFirstSource, core::queue::ConcurrentQueue<filter::data::IOData> & concurrent_queue)
{
	return new H264LiveServerMediaSession(env, reuseFirstSource, concurrent_queue);
}

H264LiveServerMediaSession::H264LiveServerMediaSession(UsageEnvironment& env, bool reuseFirstSource, core::queue::ConcurrentQueue<filter::data::IOData> & concurrent_queue) : OnDemandServerMediaSubsession(env, reuseFirstSource), 
