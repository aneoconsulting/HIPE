...
#echo  "\n--- Installing Apache2 ---\n"
#sudo yum -y install apache2 > /dev/null 2>&1


#echo  "\n--- Installing PHP7 ---\n"
#sudo  -y install php7.0 php7.0-fpm php7.0-mysql -y > /dev/null 2>&1
...
wget https://nodejs.org/dist/v8.11.3/node-v8.11.3-linux-ppc64le.tar.xz
tar xvf node-v8.11.3-linux-ppc64le.tar.xz
cd node-v8.11.3-linux-ppc64le
sudo cp -r bin include lib share /usr/local/

#sudo yum -y install nodejs rpm npm
